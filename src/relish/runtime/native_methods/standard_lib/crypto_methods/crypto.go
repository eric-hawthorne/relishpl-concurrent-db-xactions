...
// generateRsaKeyPair keyLength Int > privateKey String publicKey String err String
// """
//  Generates private key and public key as ascii-armoured (base-64) PEM strings
// """
//
//
func generateRsaKeyPair (th InterpreterThread, objects []RObject) []RObject {
}

// util/crypto_util

func GenerateRsaKeyPair(keyLen int) (privateKeyPEM string, publicKeyPEM string) {
}
...
*/
func Sign(privateKeyPEM string, content String) (signaturePEM string) {
}
