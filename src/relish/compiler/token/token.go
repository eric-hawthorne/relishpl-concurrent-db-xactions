...
// Package token defines constants representing the lexical tokens of the relish
...
// Token is the set of lexical tokens of the relis programming language,
// or will be once all the remaining Go tokens not used in relish are removed.
type Token int
